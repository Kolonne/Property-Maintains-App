...
const TIER_STYLES: Record<Tier, React.CSSProperties> = {
  ...
  progress:  { background: "#fffefb", color: "#a8593e", border: "1px solid #a8593e" },
  approved:  { background: "#fffefb", color: "#8d6a78", border: "1px solid #8d6a78" },
  done:      { background: "#7d8a6a", color: "#fffefb", border: "1px solid #7d8a6a" },
